...
// Using inline SVGs to avoid dependency on an icon library for this example.
// In a real project, using a library like lucide-react is recommended.
...
export const ScaleIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg
    ...
    className={className}
  >
    <path d="M12 22a2 2 0 0 1-2-2V7H4V5a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v2h-6v13a2 2 0 0 1-2 2Z" />
    <path d="M4 7h16" />
    <path d="M16 3v4" />
    <path d="M8 3v4" />
  </svg>
...
export const HourglassIcon: React.FC<{ className?: string }> = ({ className }) => (
  ...
  >
    <path d="M5 22h14" />
    <path d="M5 2h14" />
    <path d="M17 2v6l-5 5-5-5V2h10z" />
    <path d="M7 22v-6l5-5 5 5v6H7z" />
  </svg>
);
...
export const ZoomResetIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="24"
    height="24"
  ...
  >
    <circle cx="11" cy="11" r="8"></circle>
    <line x1="21" y1="21" x2="16.65" y2="16.65"></line>
    <path d="m13.04 8.11 2.83-2.83"></path>
    <path d="m13.04 13.04 2.83 2.83"></path>
    <path d="m8.11 13.04-2.83 2.83"></path>
    <path d="m8.11 8.11 2.83-2.83"></path>
  </svg>
);
